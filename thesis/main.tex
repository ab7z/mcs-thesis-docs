...
\newcommand{\thesistitle}{UDP Transport Options (RFC 9868)}
\newcommand{\thesissubtitle}{Implementierung und Analyse in Zig}
...
\newcommand{\thesiscompanysupervisor}{Enrico Höschler}
