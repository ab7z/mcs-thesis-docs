...
Der Autor setzte große Sprachmodelle bei der Auswertung des RFC-Primärtexts, bei Entwurf und Implementierung, bei der
Analyse der Messkampagnen und bei der Prüfung von Zwischenergebnissen ein. Wissenschaftlich belastbar ist dieses
Vorgehen nur, wenn die Arbeit offenlegt, wie Modellausgaben geprüft werden und wer die Ergebnisse verantwortet. Diese
Regeln müssen vor der Ergebnisbewertung feststehen.
...
und beschreibt die Regeln zur Prüfung ihrer Ergebnisse. Zur Einordnung dienen drei
veröffentlichte Fälle, in denen KI-Systeme an Forschungs- und
...
\begin{itemize}
  ...
  \item \textbf{Bun-Migration:} Bei der Migration von Bun von Zig nach Rust erzeugten und prüften Modelle
    derselben Familie den Quelltext. Trotz getrennter Rollen blieb ein Fehler unentdeckt, der erst nach
    dem Merge als undefiniertes Verhalten gemeldet wurde \cite{bun-in-rust,bun-pr30412,bun-issue30719}.
\end{itemize}
...
\begin{table}[htbp]
  ...
  \begin{tabularx}{\textwidth}{@{}L{0.7cm}L{3.2cm}YL{4.4cm}@{}}
    ...
    FF2
      & kontrolliertes Szenario je Pfad, Richtung und Messfenster
...
Repository der Implementierung.\footnote{\raggedright Repository der Implementierung:
...
RFC-Angaben in Dokumenten mit Arbeitsvorgaben; sie wurden dort berichtigt.
...
Menschen und Modelle müssen die Verfahrensregeln aus \tabref{tab:sprachmodell-schwaechen} anwenden. Ausführbare
Prüfungen und der Beweisprüfer liefern nach ihrem Start automatisch ein Ergebnis. Wie diese Prüfungen für FF1 aufgebaut
sind, legt der folgende Abschnitt fest.
...
stellt anschließend zwei Prüfanfragen: an Claude Code zu Codequalität und Sicherheit und an Codex als
getrennten Zweitprüfer zur RFC-9868-Semantik.
...
Merge-Bedingung ist sie nicht. Nach erfolgreicher Rust/Lean-CI werden beide KI-Prüfungen angefragt.
