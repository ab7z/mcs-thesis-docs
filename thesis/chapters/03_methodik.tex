...
Arbeit grundsätzlich geprüft wird. Aus diesem Grund wurden drei Arbeitsregeln schriftlich festgehalten:
...
Ohne weiteres Zutun urteilen nur die ausführbaren Prüfungen und der Beweisprüfer.
...
Pflichtstufe und nicht in der kontinuierlichen Integration.
...
Das lokale Gate \texttt{pre-pr.sh} Skript fährt neun feste Test-Bahnen: Formatierung, statische Analyse,
Dokumentationsbau, die Tests samt Property-Fällen, die Prüfung des eigenen Auswerters, das Lean-Tor sowie
drei Bahnen auf einem separaten Linux-Zielsystem (lokale virtuelle Maschine, aka achim),
das die Cross-Kompilierung, die Raw-Socket-Integration
...
Ob eine Prüfung tatsächlich stattfand, entscheidet
