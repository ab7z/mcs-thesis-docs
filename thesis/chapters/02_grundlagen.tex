...
Empfänger erhält jede Nachricht als atomare Einheit. RFC~768 beschreibt UDP als Verfahren, mit dem Programme Nachrichten an andere Programme senden können
...
Die \textit{Surplus Area} beginnt mit der \textit{Option Checksum (OCS)}, gefolgt von den eigentlichen Optionen im TLV-Format
(\secref{subsec:options-struktur}). Diese Struktur ermöglicht variable Optionslängen und zukünftige Erweiterungen.
